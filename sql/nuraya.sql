...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2025 at 06:47 PM
...
CREATE TABLE `orders` (
  ...
  `status` enum('en attente','en traitement','expédiée','livrée','annulée') DEFAULT 'en attente',
  `shipping_address` text NOT NULL,
  `billing_address` text NOT NULL,
  `payment_status` enum('en attente','payé','échoué','remboursé') DEFAULT 'en attente',
...
--
-- AUTO_INCREMENT for table `promo_code_uses`
--
ALTER TABLE `promo_code_uses`
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`promo_code`) REFERENCES `promotions` (`promo_code`);
...
--
ALTER TABLE `promo_code_uses`
  ADD CONSTRAINT `promo_code_uses_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `promo_code_uses_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  ADD CONSTRAINT `promo_code_uses_ibfk_3` FOREIGN KEY (`promo_code`) REFERENCES `promotions` (`promo_code`);
